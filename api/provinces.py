...
@provinces_router.post("/province", response_model=schemas.provinces.ProvinceInDB, status_code=201)
...
@provinces_router.get("/provinces", response_model=list[schemas.provinces.ProvinceInDB], status_code=200)
...
@provinces_router.get("/province/{province_id}", response_model=schemas.provinces.ProvinceInDB, status_code=200)
...
@provinces_router.put("/province/{province_id}", response_model=schemas.provinces.ProvinceInDB, status_code=200)
...
@provinces_router.delete("/province/{province_id}", status_code=200)
